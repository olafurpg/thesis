...
This section explains the most critical domain-specific optimizations that were required to get acceptable performance for scalafmt.
We will see that some optimizations are quite ad-hoc and require a lot of adaptation to work correctly.
...
Next, we look at more technique to prevent the search queue from growing out of bounds.
