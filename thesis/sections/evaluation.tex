...
Before running the benchmark, we find out how many lines of code are found in a typical source file.
...
We believe this performance is usable for occasional code formatting, but needs improvements to be acceptable for settings such as reformat on save/compile.
