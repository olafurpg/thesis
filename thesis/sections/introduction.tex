...
The promise of code formatters is to modify syntactic trivia such that a program that contains style issues, such as in listing~\ref{lst:unformatted}, turns into a readable and maintainable program, such as in listing~\ref{lst:formatted1}.
...
\begin{itemize}
  \item language-agnostic algorithms and data structures to implement line wrapping with a maximum line length setting --- in our experience, the most challenging part of developing scalafmt --- as well as configurable vertical alignment.
  ...
  \item practical validation of developed algorithms and methods with scalafmt.
